...
function angular_press_scripts() {
	...
	wp_register_script('angularjs-sanitize',get_stylesheet_directory_uri() . '/assets/node_modules/angular-sanitize/angular-sanitize.min.js',array(), '1.6.4');
    wp_enqueue_script('angular-press-main', get_stylesheet_directory_uri() . '/assets/js/main.js', array('angularjs', 'angularjs-route', 'angularjs-sanitize'), '1.0');
